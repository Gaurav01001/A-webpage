...
const Hero = () => {
  ...
  const upcomming_video_index = (currentIndex % totalVideos) + 1;


  const handleMiniVdClick = () => {
    setHasClicked(true);

    setCurrentIndex(upcomming_video_index);
  };
  ...
  }, [loadedVideos]); //check dependecy of loaded videos
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(40% 0%, 61% 0, 95% 84%, 6% 94%)",
